    ...
    return (
        <div className="bg-light-pink flex flex-col lg:flex-row justify-around py-10 items-center">
            ...
            <div className="flex flex-col">
                <div className="flex flex-row items-center text-xl md:text-2xl drop-shadow">
                    <HiOutlineMail className="text-red text-4xl mr-3" />
                    kraujalytee@gmail.com
                </div>
                <div className="flex flex-row items-center text-xl md:text-2xl drop-shadow break-all">
