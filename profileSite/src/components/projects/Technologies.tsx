...
const Technologies = () => {
    return (
        <div className="bg-pink h-screen flex ">
            <div className="bg-light-pink m-4 lg:m-14 p-3 pt-10 rounded-xl flex flex-col justify-center drop-shadow-lg">
                <div className="text-red md:text-6xl text-4xl font-primary mb-10 uppercase text-center drop-shadow">
